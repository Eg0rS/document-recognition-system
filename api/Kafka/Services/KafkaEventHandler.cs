...
public class KafkaEventHandler
{
    ...
    public async Task HandleAsync(string message)
    {
        ...
        var queryObject = new QueryObject(
            "INSERT INTO resolutions (guid, type, series, number, confidence, page_number, file_id, data) VALUES (@guid, @type, @series, @number, @confidence, @page_number, @file_id, @data)",
            new
            {
